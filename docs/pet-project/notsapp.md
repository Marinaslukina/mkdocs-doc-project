...
>Примечание.
>
>Сценарий добавлен с помощью переиспользования контента.

--8<-- "snippets/delete-scenario.md:scenario"

5. Пользователь нажимает кнопку **«Да»** в диалоговом окне.
...
--8<-- "snippets/delete-scenario.md:scenario"
1. Пользователь нажимает кнопку **«Нет»** в диалоговом окне.
